...
import neuroPluginInner from "./neuro/index.ts";
 ...
 */
const perRuntimeHooks = new WeakMap<
  IAgentRuntime,
  ReturnType<typeof createDiskBackedPromptOptimizationHooks>
>();

function getOrCreateHooksForRuntime(
...
export { neuroPluginInner as neuroPlugin, promptOptPlugin };
